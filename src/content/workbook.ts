...
export type WorkbookDay={day:number;title:string;intro:string;sections:{title:string;description?:string;fields:WorkbookField[]}[]};
...
export const workbookDays:WorkbookDay[]=[
 ...
 {day:4,title:"建立 10 分鐘嘴饞急救流程",intro:"不是強迫自己不能吃，而是在決定前先留出十分鐘的緩衝。",sections:[
  {title:"急救流程紀錄",fields:[{key:"usedTime",label:"使用時間",type:"datetime"},{key:"cravingItem",label:"當時想吃或喝什麼？",type:"text"},{key:"drankWater",label:"我先喝了一杯水",type:"checkbox",options:["已完成"]},{key:"breathingCount",label:"深呼吸次數",type:"number"},score("hungerScore","飢餓程度"),{key:"emotion",label:"當時的情緒",type:"text"},{key:"alternativeAction",label:"我選擇的替代行動",type:"checkbox",options:["洗澡","走路5分鐘","深呼吸","寫下情緒","泡熱茶","躺10分鐘","傳訊息","其他"]},{key:"cravingAfter10Min",label:"10 分鐘後嘴饞程度",type:"radio",options:["下降","一樣","更強"]},{key:"finalDidEat",label:"最後有吃嗎？",type:"radio",options:["有","沒有"]},{key:"finalChoice",label:"最後的選擇",type:"text"},{key:"selfEvaluation",label:"給今天的自己一句評價",type:"radio",options:["有進步","還需要練習","今天很不容易"]}]}
 ]},

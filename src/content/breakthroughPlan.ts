...
import {branchRoutes,type BranchKey} from "./branchRoutes";
...
export const routeProfiles:Record<EmotionalEatingType,{route:string;tools:string[];branch:BranchKey}>={stress_release:{route:"壓力止損路線",tools:["嘴饞前 3 分鐘身心連結工作本","10 分鐘嘴饞急救流程卡","安全零食與飲料替換清單"],branch:"stress_rescue"},fatigue_loss_control:{route:"營養補電路線",tools:["正念營養缺口掃描","下班後防暴食晚餐公式","外食補給導航 Pro"],branch:"energy_refill"},compensation:{route:"情緒安撫路線",tools:["嘴饞前 3 分鐘身心連結工作本","安全零食與飲料替換清單","10 分鐘嘴饞急救流程卡"],branch:"stress_rescue"},boredom_habit:{route:"習慣迴路拆解路線",tools:["下班後嘴饞觸發點分析表","10 分鐘嘴饞急救流程卡","安全零食與飲料替換清單"],branch:"habit_break"},sugary_drink_dependency:{route:"飲料降糖路線",tools:["7 天含糖飲料重置表","含糖飲料替換清單 Pro","安全零食與飲料替換清單"],branch:"drink_loop"},nutrition_gap:{route:"白天營養補洞路線",tools:["正念營養缺口掃描","下班後防暴食晚餐公式","外食補給導航 Pro"],branch:"energy_refill"}};
export const branches=branchRoutes;
...
{level:4,name:"支線岔路",task:"完成 8 個情境試煉，找出最優先攻略的主要與次要路線",tool:"攻略路線試煉",path:"",clues:["主要攻略路線","次要支線線索"],badge:"專屬支線徽章",icon:"🛤️",points:10,story:"前三關讓你看見時間、場景與訊號。現在系統會把這些情報和八個情境試煉各占一半權重，找出最值得先處理的路線。",learning:"路線不是知識題的對錯，而是依照你的角色、生活情境與實際反應決定優先順序。",feedback:"你已穿越支線岔路，選出接下來真正會影響第 5～7 關的攻略方向。"},

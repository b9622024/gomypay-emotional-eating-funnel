...
{level:7,name:"生成個人止損地圖",task:"完成我的嘴饞破關地圖",tool:"整合前 6 關所有線索",path:"map",clues:["個人止損地圖"],badge:"止損地圖完成徽章",icon:"🗺️",points:60,description:"把前 6 關的線索整理成自己的個人止損 SOP。",feedback:"你收集到的不是表格，而是更理解自己的證據。"}
] as const;

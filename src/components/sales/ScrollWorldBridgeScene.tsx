...
export default function ScrollWorldBridgeScene() {
  ...
  const exitGlow = isDesktopScrollMode ? textOpacity(progress, 0.86, 0.94, 1) : smooth(segment(progress, 0.9, 1));

  return (
    <section ref={sceneRef} className={`scroll-world-bridge-scene ${isDesktopScrollMode ? "is-desktop-natural" : ""}`} aria-label="嘴饞角色揭曉前的命運核心">

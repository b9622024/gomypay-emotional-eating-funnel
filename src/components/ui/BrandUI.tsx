...
export function ProductBundleMockup(){return <div className="bundle-stage" aria-label="數位工具包內容示意">
  <span className="blob blob-one"/><span className="blob blob-two"/>
  <div className="phone-mock"><div className="phone-speaker"/><div className="phone-screen"><span className="mini-brand">可樂吉健康研究所</span><strong>下班後<br/>嘴饞止損包</strong><small>7 天重置計畫</small><div className="phone-progress"><i/><i/><i/><i/><i/><i/><i/></div></div></div>
  <div className="workbook workbook-back"><span>TRACKER</span><b>正念營養<br/>追蹤表</b><div className="paper-lines"/></div>
  <div className="workbook workbook-front"><span>WORKBOOK</span><b>嘴饞前 3 分鐘<br/>身心連結工作本</b><div className="mock-checks"><i>✓</i><i>✓</i><i/></div></div>
  <div className="bundle-sticker">9 份<br/><b>數位工具</b></div>
</div>}
...
export function StickyCheckoutBar(){return <div className="sticky-checkout"><div><small>今日體驗價</small><strong>NT$199</strong></div><PrimaryCTA>立即取得工具包</PrimaryCTA></div>}
